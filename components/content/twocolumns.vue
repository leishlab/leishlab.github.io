    ...
    <div class="max-w-max lg:max-w-7xl mx-auto">
      <div class="relative z-10 mb-8 md:mb-2 md:px-6">
        <div class="text-base max-w-prose lg:max-w-none">
          <h1 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">{{content_h1}}</h1>
          <p class="py-2 leading-6 text-indigo-600 font-semibold tracking-wide uppercase">{{content_p}}</p>
        </div>
      </div>
      <div class="relative">
        ...
        <div class="relative md:bg-white md:p-6">
          <div class="lg:grid lg:grid-cols-2 lg:gap-6">
            ...
            <div class="prose prose-indigo prose-lg text-gray-500 lg:mt-0 mt-6">
